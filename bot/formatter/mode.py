...
def resolve_mode_name(game_mode_field, raw_label_upper: str) -> str:
    """Reproduce the exact human-readable mode resolution from the original formatter."""
...
def detect_is_turbo(game_mode_field, raw_label_upper: str) -> bool:
    """Exact Turbo detection parity with the original formatter."""
    return (
